...
- **License**: GPL-3.0 / MIT.
- **Source Code**: [GitHub Repository](https://github.com/DrakesCraft-Labs/Networks---Better-Compatibility-Unofficial-)
- **Support & Issues**: [GitHub Issues](https://github.com/DrakesCraft-Labs/Networks---Better-Compatibility-Unofficial-/issues) | [Discord](https://discord.gg/rR7FbfCt9Y)
